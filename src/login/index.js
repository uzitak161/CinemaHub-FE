...
import './login.css'; // Make sure to import or include your CSS styles


const Login = () => {
    const [isLogin, setLogin] = useState(true); // State to track if it's a login or signup form
    const [selected, setSelected] = useState(''); // State to track which form is selected


   
    const switchSignup = () => {
        // We are currently on the login form
        if (isLogin) {
            setSelected('log-in');
            setLogin(false);
        }
    ...
    const switchLogin = () => {
        // We are currently on the signup form
        if (!isLogin) {
            setSelected('');
            setLogin(true);
        }
    ...
    const handleLogin = () => {
        // Make API call to login; check reponse
        // pretend response was positive
        setSelected('active')
    }
    ...
    return (
        <div>
            <div>
                <h1 className='title'>CinemaHub</h1>
            </div>
            <div className={`container login-body ${selected}`}>
                <div class="box"></div>
                        ...
                        <div class="info-item">
                            <div class="table">
                                <div class="table-cell">
                                    ...
                                    <div class="btn" onClick={switchLogin}>
                                        Log in
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="info-item">
                            <div class="table">
                                <div class="table-cell">
                                    ...
                                    <div class="btn" onClick={switchSignup}>
                                        Sign up
                                    </div>
                                </div>
                            </div>
